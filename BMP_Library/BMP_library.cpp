...
void BMP_library::embedTextInImage(const string& imagePath, const string& message, const string& outputImagePath) {
    ...
    std::string BMP_library::extractTextFromImage(const std::string& imagePath) {
        Mat image = imread(imagePath);
